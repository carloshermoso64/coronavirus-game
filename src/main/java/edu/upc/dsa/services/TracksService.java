...
@Api(value = "/tracks", description = "Punto de entrada TrackService")
@Path("/tracks")
public class TracksService {
    ...
    @GET
    @ApiOperation(value = "Deme todos los faxes", notes = "asdasd")
    @ApiResponses(value = {
    ...
    @GET
    @ApiOperation(value = "Deme un faxe concreito", notes = "asdasd")
    @ApiResponses(value = {
